...
const mineTexture = textureLoader.load("/textures/minecraft.png");
...
ambientOcclusionTexture.rotation = Math.PI / 4;
...
const material = new THREE.MeshBasicMaterial({ map: mineTexture });
