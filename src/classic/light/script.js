...
directionalLight.position.set(0.3, 0.8, 2);

const hemisphereLight = new THREE.HemisphereLight(0xff0000, 0x0000ff, 0.3);

const pointLight = new THREE.PointLight(0xff9000, 0.7, 10, 5);
pointLight.position.set(0, -0.5, 1);

const rectAreaLight = new THREE.RectAreaLight(0x4e00ff, 0.7, 3, 1);
